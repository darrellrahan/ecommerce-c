...
void listBySearchKeyword(char keyword[])
{
    ...
    struct Produk foundProduk[100]; // Array untuk menyimpan hasil pencarian
    int foundProdukIndex = 0;

    char buffer[256];

    // Baca data dari file dan cari berdasarkan keyword
    ...
    // Menampilkan opsi untuk detail produk
    printf("\n");
    for (int i = 0; i < foundProdukIndex; i++)
    {
