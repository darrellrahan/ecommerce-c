...
void listByKategori(char selectedCategory[])
{
    ...
    struct Produk listProdukByKategori[100];
    int listProdukByKategoriIndex = 0;

    char buffer[256];

    // Baca data dari file dan filter berdasarkan kategori
    ...
    // Tampilkan daftar produk berdasarkan kategori
    ...
    // Tampilkan opsi untuk melihat detail produk
    for (int i = 0; i < listProdukByKategoriIndex; i++)
    {
